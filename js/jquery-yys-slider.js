...
(function($) {
	$.fn.gallery_slider = function(options) {
  	...
  	_this.find(_gallery_item_left).on('click',function(){
			...
			_this.find(_threeD_gallery_item).eq(idx == 0 ? idx + _imgNum - 1 : idx - 1).removeClass('gallery_right_middle').addClass('gallery_left_middle');
		...
		_this.find(_gallery_item_right).on('click',function(){
			...
			_this.find(_threeD_gallery_item).eq(idx == 1 ? idx + _imgNum - 2 : idx - 2).removeClass('gallery_left_middle').addClass('gallery_right_middle');
